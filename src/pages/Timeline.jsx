    ...
    return (
        <div className='bg-[#f8fafc] flex flex-col min-h-screen'>
            ...
            <div className="w-[70%] mx-auto  my-6 p-4 space-y-6">
                ...
                <h1 className='font-bold text-[#1F2937] text-[48px]'>Timeline</h1>

                <div className="flex  mb-6">
                    <select
                        value={filter}
                        onChange={(e) => setFilter(e.target.value)}
                        className="border border-gray-300  w-[300px] rounded px-3 py-2 bg-white text-[#64748b] focus:outline-none"
                    >
                ...
                {filteredTimeline.length === 0 ? (
                    <div className="flex justify-center">
                        <div className="bg-white shadow-sm rounded-xl p-10 text-center w-full my-30 md:w-[60%] lg:w-[60%]">
                            <p className="text-gray-500 md:text-[48px] text-[24px]  font-medium">
                                No activity yet
                            </p>
                        </div>
                    </div>) : (
